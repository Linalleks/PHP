...
echo "<p>Задание 1<br>Площадь трапеции равна $s</p>";
...
echo "<p>Задание 2<br>Сумма пар чисел из числа 541967 равна $sum<br>
Произведение 2х половин числа 541967 равно $multi</p>";

// Задание 2 другим способом

$num = 541967;

$sum = floor($num / 10000) + floor(($num % 10000) / 100) + ($num % 100) ;

$multi = floor($num / 1000) * ($num % 1000);

echo "<p>Задание 2 (способом нахождения остатка от деления)<br>Сумма пар чисел из числа 541967 равна $sum<br>
Произведение 2х половин числа 541967 равно $multi</p>";
